...
/datum/virtue/utility/blacksmith
	...
	added_skills = list((/datum/skill/craft/crafting, 2, 2),
						(/datum/skill/craft/weaponsmithing, 2, 2),
						(/datum/skill/craft/armorsmithing, 2, 2),
						(/datum/skill/craft/blacksmithing, 2, 2))
...
/datum/virtue/utility/tailor
	...
	added_skills = list((/datum/skill/craft/crafting, 2, 2),
						(/datum/skill/labor/butchering, 2, 2),
						(/datum/skill/craft/sewing, 2, 2),
						(/datum/skill/craft/tanning, 2, 2)),
...
/datum/virtue/utility/physician
	...
	added_skills = list((/datum/skill/craft/crafting, 2, 2),
						(/datum/skill/craft/alchemy, 2, 2),
						(/datum/skill/misc/medicine, 2, 2))
...
/datum/virtue/utility/hunter
	...
	added_skills = list((/datum/skill/craft/traps, 2, 2),
						(/datum/skill/labor/butchering, 2, 2),
						(/datum/skill/craft/tanning, 2, 2),
						(/datum/skill/misc/tracking, 2, 2))
...
/datum/virtue/utility/artificer
	...
	added_traits = list(TRAIT_SMITHING_EXPERT)
	added_skills = list((/datum/skill/craft/crafting, 2, 2),
						(/datum/skill/craft/carpentry, 2, 2),
						(/datum/skill/craft/masonry, 2, 2),
						(/datum/skill/craft/engineering, 2, 2),
						(/datum/skill/craft/ceramics, 2, 2))

	added_stashed_items = list(("Hammer" = /obj/item/rogueweapon/hammer/wood),
...
/datum/virtue/utility/mining
	...
	added_stashed_items = list(("Steel Pickaxe" = /obj/item/rogueweapon/pick/steel),
								("Lamptern" = /obj/item/flashlight/flare/torch/lantern),
								("Ore Bag" = /obj/item/storage/hip/orestore/bronze))

	added_skills = list((/datum/skill/labor/mining, 3, 3,)
						(/datum/skill/craft/smelting, 3, 3))
