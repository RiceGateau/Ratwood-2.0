...
/datum/mapGenerator/underdark
	modules = list(/datum/mapGeneratorModule/underdarkstone, /datum/mapGeneratorModule/underdarkmud, /datum/mapGeneratorModule/underdarkscarymud, /datum/mapGeneratorModule/underdarkscarystone)
...
/datum/mapGeneratorModule/underdarkscarymud
	clusterCheckFlags = CLUSTER_CHECK_SAME_ATOMS
	allowed_areas = list(/area/rogue/under/underdarker)
	allowed_turfs = list(/turf/open/floor/rogue/dirt)
	excluded_turfs = list(/turf/open/floor/rogue/dirt/road)
