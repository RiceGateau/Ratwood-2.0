/mob/living/carbon/human/species/undead/shiki
	race = /datum/species/undead/shiki

/datum/species/undead/shiki
	name = "Humen"
	id = "humen"
	desc = "<b>Humen</b><br>\
	Shiki (or \"corpse demons\") are the eldest of the Weeping God's creations. Noted for their \
	...
	banned_traits = list()
	race_bonus = list(STAT_ENDURANCE = -2, STAT_WILLPOWER = -2, STATBONUS = 2)
	race_statmin = list()
	race_statmax = list()
...
/datum/species/undead/shiki/check_roundstart_eligible()
	return TRUE


/datum/species/undead/shiki/get_skin_list()
	return list(
		"Humen" = SKIN_COLOR_GHOST,
	)

/datum/species/undead/shiki/get_hairc_list()
