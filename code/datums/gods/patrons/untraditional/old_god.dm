/datum/patron/old_god
	...
	desc =
	"The One granted us lyfe, and bravely fought back the Necromantress Zizo to save us all, in this fight;\
	He was struck down by the Necromantress Zizo, the Tennites believe Him dead, but we know the truth.\
	PSYDON YET LIVES, PSYDON YET ENDURES. By PSYDON's light May we ENDURE in His name, then the world will be Good once more."
	
	
	worshippers = "Ancient Dwarves and Elves, Zybantines, Otavans, Those Who Dream of Peace"
	associated_faith = /datum/faith/untraditional
	godhead = /datum/patron/old_god
	banned_traits = list(TRAIT_HEMOPHAGE, TRAIT_SKELETONIZED, TRAIT_ROTMAN,) //No Undead Esc Worshipers, They Would Get Cured Or Kill Themselves If Turned & Not Mind Altered
